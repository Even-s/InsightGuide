  ...
  return (
    <div className="min-h-screen bg-cream-50 py-8">
      <div className="max-w-6xl mx-auto px-4">
        ...
        {error && (
          <div className="motion-status-in bg-red-50 rounded-xl p-4 border border-red-200 mb-6">
        ...
        {/* No BRD exists */}
        {!brd && !generating && (
          <div className="motion-surface-in bg-white rounded-xl shadow-sm p-8 text-center">
        ...
        {(generating || brd?.status === 'generating') && (
          <div className="motion-fade-in bg-white rounded-xl shadow-sm p-8 text-center">
        ...
        {brd && brd.status === 'completed' && (
          <div className="motion-reveal-in space-y-6">
            {/* Actions */}
