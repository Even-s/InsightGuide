...
class ProjectService:
    ...
    def create_project(self, db: Session, user_id: str, title: str, description: Optional[str] = None) -> Project:
    ...
    def _summarize_description(self, title: str, description: Optional[str]) -> Optional[str]:
        ...
        try:
            ...
            response = openai_service.client.chat.completions.create(
                model="gpt-5.4-mini",
                messages=[
                    {"role": "system", "content": "你是專案管理助理。將使用者的專案描述濃縮為一句簡潔的中文，說明這個專案要做什麼、為誰做。不要加引號，不要重複專案名稱，只回傳那一句話。"},
    ...
    def update_project(self, db: Session, project_id: str, data: Dict[str, Any]) -> Optional[Project]:
